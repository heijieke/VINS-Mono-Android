...
//    cv::rotate(srcRgba, rotatedRgba, cv::ROTATE_180);
//    uchar *sbuf = rotatedRgba.data;
//    for (int i = 0; i < rotatedRgba.rows; i++) {
//        dbuf = dstRgba.data + i * buf.stride * 4;
//        memcpy(dbuf, sbuf, rotatedRgba.cols * 4); //TODO: threw a SIGSEGV SEGV_ACCERR once
//        sbuf += rotatedRgba.cols * 4;
//    }
