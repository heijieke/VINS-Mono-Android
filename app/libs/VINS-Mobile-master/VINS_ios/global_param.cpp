...
{
    //device is const in Viewcontroller::deviceName
    switch (device) {
        case iPhone7P:
...
//            PY = 177.33389;
            ...
            break;
        case Lenovo_L70081:
            printf("Device Lenovo_L70081 param\n");
            FOCUS_LENGTH_Y = 1347.083407026405;
            FOCUS_LENGTH_X = 1347.9642553245442;
            PY = 545.4604690971368;
            PX = 983.2038402523725;
            ...
            //extrinsic param
            // TIC = Translation IMU to Camera
            TIC_X = -0.021953429287315945; // view direction
            TIC_Y = -0.023901163590969225; //-0.005 // to the left when device is in landscape (up when normal)
            TIC_Z = 0.03046659133502092; //-0.018792; // up when in landscape (right when normal)
            return true;
            break;
        case unDefine:
            return false;
